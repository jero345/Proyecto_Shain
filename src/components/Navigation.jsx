import {
  ...
  X,
  CalendarClock, 
  ClipboardList, // 👈 Nuevo icono para citas agendadas
} from 'lucide-react';
...
const navItems = [
  ...
  { icon: <CalendarClock size={20} />, label: 'Agendar Citas', to: '/dashboard/agendar-cita' },
  { icon: <ClipboardList size={20} />, label: 'Citas Agendadas', to: '/dashboard/citas' }, // ✅ Nueva opción
